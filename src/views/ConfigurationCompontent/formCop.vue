<template>
    <div class="wrapper">
           <upLoad   v-if="tabKey === 'upLoad'"@sub="sub" keys='upLoad' />
           <stockLine v-if="tabKey === 'stockLine'"@sub="sub" keys='stockLine'/>
           <initialSort v-if="tabKey === 'initialSort'"@sub="sub" keys='initialSort'/>
           <downLine  v-if="tabKey === 'downLine'"@sub="sub" keys='downLine'/>
           <downLoad  v-if="tabKey === 'downLoad'"@sub="sub" keys='downLoad'/>
