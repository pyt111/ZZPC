...
export default class upLoad extends Vue {
    ...
    //     if (val === this.keys) {
    //         //判断当前所在区域是  upLoad 上货口  是则请求接口
    //     }
    //     console.log("当前点击的区域---", val);
    // }
    @Watch("nowName")
    getName() {
        ...
        if (this.keys === this.nowKey) {
            ...
            this.getPortInfoFun(data)
                .then((res: any) => {
                    ...
                    this.data.downloadFlag = res.downloadFlag + "" || "";
                    this.data.effectiveTo =
                        (this as any).time1(res.effectiveTo) || "";
    ...
    mounted() {
        // console.log(this.keys,'222233333333');
